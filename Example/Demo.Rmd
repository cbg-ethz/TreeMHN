...
To ensure enough precision, we run stability selection with $\gamma = 0.07$ and a threshold of $95\%$ and obtain a vector of non-selected elements over $1000$ subsamples. Again, we recommend to run the code using the `parallel` package on a cluster.
